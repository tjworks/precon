...
/**
 * RelatedGenesWebResponseDtoMock: RelatedGenesWebResponseDto mock object
 * Created Jul 24, 2009
 * @author Ovi Comes
 */
...
public class RelatedGenesWebResponseDtoMock {
	...
	public static RelatedGenesWebResponseDto getMockObject(long id) {
		...
		networks.add(InteractionNetworkMock.getMockObject(1));
