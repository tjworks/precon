...
public class SearchParameters {
	...
	public SearchParameters(Organism organism, Collection<Gene> genes,
			Collection<InteractionNetwork> networks, CombiningMethod weighting,
			int resultsSize, String namespace) {
		super();
	...
	public String toString() {
		return "SearchParameters [genes=" + genes + ", namespace=" + namespace
				+ ", networks=" + networks + ", organism=" + organism
				+ ", resultsSize=" + resultsSize + ", weighting=" + weighting
				+ "]";
	}
