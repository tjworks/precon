...
public class MatrixUtilsTest extends TestCase {
	...
	public void testSimple() {
		...
		assertEquals(0.0d, sums.get(0));
		assertEquals(0.0d, sums.get(1));
		
		sums = MatrixUtils.rowSums(m);
		assertEquals(3, sums.size());
		assertEquals(0.0d, sums.get(0));
		assertEquals(0.0d, sums.get(1));		
		assertEquals(0.0d, sums.get(2));	
	}
	...
	public void testDense() {
		...
		Vector sums = MatrixUtils.columnSums(m);
		assertEquals(2, sums.size());
		assertEquals(9.0d, sums.get(0));
		assertEquals(12.0d, sums.get(1));
		
		sums = MatrixUtils.rowSums(m);
		assertEquals(3, sums.size());
		assertEquals(3.0d, sums.get(0));
		assertEquals(7.0d, sums.get(1));	
		assertEquals(11.0d, sums.get(2));
	}
	...
	public void testGetSubMatrix() {
		...
		assertEquals(1d, subm.get(0,0)); // should be in both m and subm
		assertEquals(0d, subm.get(1,1)); // should be in neither m nor subm
		assertEquals(0d, subm.get(0,1)); // was in m but should not be in subm
		...
		assertEquals(0d, subm.get(0,0));  
		assertEquals(0d, subm.get(1,1));  
		assertEquals(4d, subm.get(0,1));  
	...
	public void testMultiplySum() {
		...
		assertEquals(28d, MatrixUtils.elementMultiplySum(a, b));
	}

	public void zzztestNaNs() {
	...
	public void testColumnCountsIgnoreMissingData() {
		...
		assertEquals(2d, counts.get(0));
		assertEquals(2d, counts.get(1));
		assertEquals(3d, counts.get(2));
	}
	...
	public void testColumnMeanIgnoreMissingData() {
		...
		assertEquals(3d, means.get(0));
		assertEquals(5d, means.get(1));
		assertEquals(6d, means.get(2));
	}
	...
	public void testColumnVarianceIgnoreMissingData() {
		...
		assertEquals(4d, variances.get(0));
		assertEquals(1d, variances.get(1));
		assertEquals(6d, variances.get(2));		
	}
	...
	public void testTieRankDense(){
		...
		for ( int i = 0; i < res1.size(); i++){
			assertEquals(res1.get(i), test1.get(i));
			assertEquals(res2.get(i), test2.get(i));
			assertEquals(res3.get(i), test3.get(i));
			assertEquals(res4.get(i), test4.get(i));
			assertEquals(res5.get(i), test5.get(i));
			assertEquals(res6.get(i), test6.get(i));
			assertEquals(res7.get(i), test7.get(i));
			assertEquals(res8.get(i), test8.get(i));
			assertEquals(res9.get(i), test9.get(i));
		}
    ...
    public void testVarianceNumerical() {
        ...
        assertEquals(TEST_VAL, means.get(0));
        assertEquals(0d, variances.get(0));
