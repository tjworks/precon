...
public class KHeapTest extends TestCase {
	...
	public void testExtensible(){
		...
		for ( int i = 0; i < 5; i++ ){
			...
			assertEquals(extensible.getWeight(i), 1.0);
		}
	...
	public void testPop() {
        ...
        assertEquals(2d, heap.getWeight(0));
        ...
        assertEquals(3d, heap.getWeight(0));
        
        assertEquals(4d, heap.getWeight(1));
        ...
        assertEquals(4d, heap.getWeight(0));
