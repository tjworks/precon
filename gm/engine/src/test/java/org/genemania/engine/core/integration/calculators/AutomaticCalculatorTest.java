...
import org.genemania.engine.config.MTJDoubleMatrixFactory;
...
public class AutomaticCalculatorTest {
    ...
    public void testProcess() throws Exception {
        ...
        INetworkWeightCalculator calculator = new AutomaticCalculator(cacheBuilder.getCache(), groups, org1Id, labels, NullProgressReporter.instance());
        calculator.process();
