...
public class Constants {
    ...
    public static final boolean DEFAULT_NORMALIZE_NETWORK_WEIGHTS_ENABLED = false;
    public static final boolean DEFAULT_COMBINED_NETWORK_NORMALIZATION_ENABLED = true;
