...
public class AddEnrichmentOntology {
    ...
    public AddEnrichmentOntology(DataCache cache, AddOntologyEngineRequestDto request) {
        this.cache = cache;
    ...
    public AddOntologyEngineResponseDto process() throws ApplicationException {
        ...
        AddOntologyEngineResponseDto response = new AddOntologyEngineResponseDto();
        return response;
