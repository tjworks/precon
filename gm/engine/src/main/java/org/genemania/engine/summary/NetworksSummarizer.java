...
public class NetworksSummarizer implements Summarizer {
	...
	public NetworksSummarizer(Organism organism, DataConnector dataConnector) throws Exception {
		...
		this.preferredNames = new PreferredNames(organism.getId(), dataConnector, 
				"Entrez Gene ID", "Ensembl Gene ID", "TAIR ID", "Entrez Gene Name", "Ensembl Gene Name", "Ensembl Protein ID", "Uniprot ID"); // TODO: don't hardcode this list!
	}
