...
public class DatasetPublisher extends AbstractEngineApp {
    ...
    void summarizeOrganism(Organism organism) throws Exception {
        ...
        ReporterFactory reporterFactory = new TabularReporterFactory(reportSubdir + File.separator + orgname);
        Summarizer summarizer = null;

        PreferredNames preferredNames = new PreferredNames(organism.getId(), dataConnector, 
                "Ensembl Gene ID", "Entrez Gene ID", "TAIR ID", "Entrez Gene Name", "Ensembl Gene Name", "Ensembl Protein ID", "Uniprot ID"); // TODO: don't hardcode this list!
