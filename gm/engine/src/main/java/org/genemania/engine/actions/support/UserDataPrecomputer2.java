...
public class UserDataPrecomputer2 {
    ...
    public UserDataPrecomputer2(String namespace, int organismId,
...
//            userKtT[branch] = MatrixUtils.copyLarger(userKtT[branch], 1, 0);
    ...
    public void updateKtT(long networkId, SymMatrix network) throws ApplicationException {
        ...
        for (int branch = 0; branch < Constants.goBranches.length; branch++) {
            ...
            double val = CalculateFastWeights2.computeKttElement(numberOfGenes, network, coAnnotationMatrix, annoSet.GetBHalf(), annoSet.GetConstant());
    ...
    /*
     * clean up a users precomputed data structres associated with
     * an organism. 
     */
