...
public class CalculateNetworkWeights {
     ...
     * no namespace
     */
    public CalculateNetworkWeights(DataCache cache, Collection<Collection<Long>> networkIds, int organismId, Vector label, CombiningMethod method, ProgressReporter progress) throws ApplicationException {
        this.cache = cache;
     ...
     * namespace given
     */
    public CalculateNetworkWeights(String namespace, DataCache cache, Collection<Collection<Long>> networkIds, int organismId, Vector label, CombiningMethod method, ProgressReporter progress) throws ApplicationException {
    ...
    public void process() throws ApplicationException {
        INetworkWeightCalculator calculator = NetworkWeightCalculatorFactory.getCalculator(namespace, cache, networkIds, organismId, label, method, progress);
