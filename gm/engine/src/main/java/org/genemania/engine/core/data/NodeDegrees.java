...
/**
 * store the degree of each node in the organism,
 * indexed via the nodeIds object
 */
public class NodeDegrees extends Data {
    private DenseVector degrees;

    public NodeDegrees(String namespace, long organismId) {
    ...
    public void setDegrees(DenseVector nodeDegrees) {
        this.degrees = nodeDegrees;
    }
