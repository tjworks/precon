$(function(){
    ...
    $(".per_cent_bar").each(function(){
        var width = $(this).parent().closest(":has(.per_cent_text)").find(".per_cent_text:first").text();
        width = (width.indexOf("<")==0) ? width.substring(1) : width;
