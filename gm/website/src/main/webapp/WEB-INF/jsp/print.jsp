			    ...
			    <div class="legend_area">
			    	...
			    	<div class="legend networks">
			    		...
			    		<c:forEach items="${results.resultNetworkGroups}" var="rNetworkGroup">
				    		<div class="entry" netid="${rNetworkGroup.networkGroup.id}" colour="${network_colors[rNetworkGroup.networkGroup.id]}">
				    			<span class="colour" style="border-color: ${network_colors[rNetworkGroup.networkGroup.id]};"></span>
				    			<span class="name">${rNetworkGroup.networkGroup.name}</span>
				    		</div>
			    		</c:forEach>
