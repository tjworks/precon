...
<tr>
<th><a href="#section/cross-validator">Cross Validator</a></th>
...
<tr>
<th><a href="#section/network-assessor">Network Assessor</a></th>
...
<tr>
<th><a href="#section/network-importer">Network Importer</a></th>
<td>Imports network/profile data from a file into a GeneMANIA data set.</td>
</tr>

<tr>
<th><a href="#section/validation-set-maker">Validation Set Maker</a></th>
...
<h2 id="section/gene-sanitizer">Gene Sanitizer</h2>
<div class="section">
<p>
...
<td>The name or taxonomy id of an <a href="#section/available-organisms">organism</a> whose genes should be considered.</td>
</tr>
</table>

</div>

<h2 id="section/id-importer">Id Importer</h2>
<div class="section">
<p>
...
<h2 id="section/query-runner">Query Runner</h2>
<div class="section">
<div>
...
<td>
	...
	<ul>
		<li><code>flat</code> (default): Tab-delimited (<a href="#section/flat-example">example</a>).</li>
...
<h3 id="section/flat-example">Example Query (Flat):</h3>
...
<div class="sampleCode"><a href="#section/available-organisms">organism-name</a>
query-gene-1 [ \t query-gene-2 ... ]
<a href="#section/available-networks">networks</a>
related-gene-limit
[ <a href="#section/available-combining-methods">combining-method</a> ]
</div>
</div>

<h2 id="section/cross-validator">Cross Validator</h2>
<div class="section">
<p>
Runs one or more predictions and writes the results to disk. Each prediction needs to be provided in the form of a query file. One prediction report is generated for each query file.
</p>
...
<td>Perform validation against the gene sets listed in the given file.  It must be formatted <a href="#section/validation-query-format">this way</a>.</td>
</tr>

<tr>
<th class="option">--networks <em class="parameter">network-list</em></th>
<td>A comma-separated list of <a href="#section/available-networks">network types</a> and/or network names.  To get a full listing of network names, use the option <code>--list-networks</code>.</td>
</tr>

<tr>
<th class="option">--exclude-networks <em class="parameter">network-list</em></th>
<td>Optional.  A comma-separated list of <a href="#section/available-networks">network types</a> and/or network names to exclude from the <code>--networks</code> list.</td>
</tr>
...
<td>Optional.  The <a href="#section/available-combining-methods">weighting method</a> to use when combining the individual networks.  Defaults to <code>automatic</code>.</td>
</tr>
...
<h3 id="section/validation-query-format">Query File Format:</h3>
<p>
...
<h2 id="section/network-assessor">Network Assessor</h2>
<div class="section">
<p>
...
<tr>
<th class="option">--query <em class="parameter">file-name</em></th>
<td>Perform validation against the gene sets listed in the given file.  It must be formatted <a href="#section/query-format">this way</a>.</td>
</tr>

<tr>
<th class="option">--baseline <em class="parameter">network-list</em></th>
<td>A comma-separated list of <a href="#section/available-networks">network types</a> and/or network names to use as a baseline for comparison.  To get a full listing of network names, use the option <code>--list-networks</code>.</td>
</tr>

<tr>
<th class="option">--exclude-baseline <em class="parameter">network-list</em></th>
<td>Optional.  A comma-separated list of <a href="#section/available-networks">network types</a> and/or network names to exclude from the <code>--baseline</code> list.</td>
</tr>

<tr>
<th class="option">--networks <em class="parameter">network-list</em></th>
<td>A comma-separated list of <a href="#section/available-networks">network types</a> and/or network names representing the networks to assess.  To get a full listing of network names, use the option <code>--list-networks</code>.</td>
</tr>
...
<p>
Network Assessor uses the same <a href="#section/validation-query-format">query file format</a> as Cross Validator.
</p>
</div>

<h2 id="section/network-importer">Network Importer</h2>
<div class="section">
<p>
...
<td>Optional.  The <a href="#section/available-networks">network group</a> to which the new network will be added.  If this group does not exist, it will be created.  Defaults to <code>other</code>.</td>
</tr>
...
<h2 id="section/validation-set-maker">Validation Set Maker</h2>
<div class="section">
<p>
...
<h3 id="section/available-organisms
">Organisms:</h3>
<table class="options">
<tr>
<th>Name</th>
...
<h3 id="section/available-networks">Networks</h3>
<p>
...
<h3 id="section/available-combining-methods">Weighting Methods</h3>
<table class="options">
<tr>
