<div id="advanced_line" class="line">
	<c:if test="${!empty results}">
		<div id="results_count_notification" tooltip="<spring:message code="advanced_options.results_count_notification.tooltip"/>"><spring:message code="advanced_options.results_count_notification.pre"/> ${params.resultsSize} <spring:message code="advanced_options.results_count_notification.post"/></div>
	</c:if>
	        ...
	        <div id="advanced_options" class="inset light_section ui-corner-bottom">
	                    ...
	                    <table id="network_toggle" cellspacing="0" cellpadding="0">
	                        <tr>
	                            <td width="100%">
	                                ...
	                                <br/>
	                                <spring:message code='search_networks.controls.sort_by'/> <a class="action_link sort" href="#" id="network_sorting_sortByFirstAuthor"><spring:message code='search_networks.controls.first_author'/></a>, <a class="action_link sort" href="#" id="network_sorting_sortByLastAuthor"><spring:message code='search_networks.controls.last_author'/></a>, <a class="action_link sort" href="#" id="network_sorting_sortByPubDate"><spring:message code='search_networks.controls.date'/></a>, <a class="action_link sort" href="#" id="network_sorting_sortByNetworkSize"><spring:message code='search_networks.controls.size'/></a>
	                            </td>
	                            <td>
	            ...
	            <div class="line">
	                <fieldset>
	                    ...
	                    <div>
	                        <span style="white-space:pre"><spring:message code='results.number.phrase.start'/></span> 
