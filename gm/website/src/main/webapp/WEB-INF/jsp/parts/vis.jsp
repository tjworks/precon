	...
	<ul>		
		...
		<li id="menu_layout"><label><spring:message code='menu.actions'/></label>
			<ul class="over_flash">
                ...
                <li id="menu_merge_links" class="ui-menu-checkable"><label tooltip="<spring:message code='menu.merge_links.tooltip'/>"><spring:message code='menu.merge_links'/></label></li>
                <li id="menu_transparent_edges" class="ui-menu-checkable"><label tooltip="<spring:message code='menu.menu_transparent_edges.tooltip'/>"><spring:message code='menu.menu_transparent_edges'/></label></li>
